...
//   return (
//     <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 animate-slide-up">
...
//           <span className="text-xs bg-primary/90 text-primary-foreground px-2.5 py-1 rounded-full font-semibold shadow-md">
...
//           <Button
//             variant="outline"
//             className="w-full h-9 text-sm font-medium transition-all hover:shadow-md bg-transparent"
//           >
//             View
//           </Button>
//         </Link>
...
//           size="sm"
//           onClick={onDelete}
//           className="flex-1 h-9 text-sm font-medium transition-all hover:shadow-md"
//         >
//           Delete
//         </Button>
//       </CardFooter>
...
// import type { Product } from "@/lib/slices/productsSlice"
// import Image from "next/image"
// import { Eye, Edit, Trash2, Tag, Calendar, Image as ImageIcon } from "lucide-react"
...
//   return (
//     <Card className="group relative overflow-hidden border border-[#AD8A64]/30 
...
//       hover:border-[#4E6E5D]/40">

//       {/* Background Gradient Effect */}
//       <div className="absolute inset-0 bg-gradient-to-br from-[#EFF1F3] via-white to-[#AD8A64]/5 
//         opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

//       {/* Image Container */}
//       <div className="relative h-48 bg-gradient-to-br from-[#AD8A64]/10 to-[#4E6E5D]/10 overflow-hidden">
//         {hasImages ? (
...
//             {/* Image Count Badge */}
//             {imageCount > 1 && (
//               <div className="absolute top-3 left-3 bg-[#0D1821]/80 text-white 
...
//             )}
//             {/* Image Overlay */}
//             <div className="absolute inset-0 bg-gradient-to-t from-[#0D1821]/10 via-transparent to-transparent 
//               opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//           </div>
//         ) : (
//           <div className="w-full h-full flex items-center justify-center">
//             <div className="text-center space-y-3">
//               <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#A44A3F]/20 to-[#4E6E5D]/20 
//                 flex items-center justify-center mx-auto shadow-inner">
//                 <span className="text-2xl">📦</span>
//               </div>
//               <p className="text-xs text-[#4E6E5D] font-medium">No image available</p>
//             </div>
//           </div>
//         )}
...
//         {/* Category Badge */}
//         <div className="absolute top-3 right-3">
//           <span className="flex items-center gap-1 text-xs bg-[#4E6E5D] text-white 
...
//         <div className="absolute inset-0 bg-[#0D1821]/70 opacity-0 group-hover:opacity-100 
//           transition-all duration-500 flex items-center justify-center gap-3">
//           <Link href={`/products/${product.slug}`} className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
//             <Button
//               size="sm"
...
//             </Button>
//           </Link>
//           <Link href={`/products/${product.slug}/edit`} className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
//             <Button
//               size="sm"
...
//       <CardContent className="relative pt-4 pb-3 space-y-3">
//         {/* Product Name */}
//         <div>
//           <h3 className="font-bold text-lg text-[#0D1821] line-clamp-2 
//             group-hover:text-[#4E6E5D] transition-colors duration-300 leading-tight">
//             {product.name}
//           </h3>
//           <p className="text-sm text-[#4E6E5D] line-clamp-2 mt-2 leading-relaxed">
//             {product.description}
//           </p>
//         </div>

//         {/* Price & Date Row */}
//         <div className="flex justify-between items-center pt-3 border-t border-[#AD8A64]/20">
...
//       <CardFooter className="relative gap-2 pt-3 border-t border-[#AD8A64]/20">
//         <Link href={`/products/${product.slug}`} className="flex-1">
//           <Button
//             variant="outline"
...
//       {/* Corner Accents */}
//       <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#A44A3F] 
//         rounded-tl-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//       <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#4E6E5D] 
//         rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//       <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#AD8A64] 
//         rounded-bl-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
//       <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#4E6E5D] 
