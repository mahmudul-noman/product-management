...
export function ProductForm({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.images.length === 0 || !formData.images[0].trim()) {
      ...
      const invalidUrls = formData.images.filter(
        ...
        <form onSubmit={handleSubmit} id="product-form" className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Input
              ...
              disabled={loading}
              className={`h-11 border-2 transition-all duration-300 rounded-xl ${
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              disabled={loading}
              className={`w-full px-3 py-3 border-2 rounded-xl bg-white text-[#0D1821] placeholder-[#4E6E5D]/60 focus:outline-none transition-all duration-300 resize-none h-32 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#4E6E5D] font-semibold">
                  $
                </span>
                <Input
                  id="price"
                  ...
                  disabled={loading}
                  className={`pl-7 border-2 transition-all duration-300 rounded-xl ${
                ...
                <SelectContent className="border-2 border-[#AD8A64]/20 rounded-xl">
                  {categories.map((cat) => (
                    <SelectItem
                      key={cat.id}
                      value={cat.id}
                      className="hover:bg-[#4E6E5D]/10 focus:bg-[#4E6E5D] transition-colors"
                    >
                      {cat.name}
                    </SelectItem>
                  ))}
