...
//       <DeleteConfirmDialog
//         open={!!deleteId} // ✅ Correct prop name
//         onConfirm={handleDelete}
//         onCancel={() => setDeleteId(null)}
//         title="Delete Product"
//         description="Are you sure you want to delete this product? This action cannot be undone."
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0D1821]">Success!</h4>
                    <p className="text-[#4E6E5D] text-sm font-medium">
                ...
                <button
                  ...
                  className="text-[#4E6E5D] hover:text-[#A44A3F] transition-colors duration-200 p-1 rounded-lg hover:bg-[#4E6E5D]/10"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
